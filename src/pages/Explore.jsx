...
const RentalFleetCars = () => {
  ...
  return (
    <div className="max-w-7xl text-white mx-auto px-4 py-8">
      <h1 className="text-4xl text-green-400 font-bold mb-2">Our Fleet</h1>
      <p className="text-xl mb-8">Quality vehicles for rent at competitive rates</p>

      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {rentalCars.map((car) => (
          <div key={car.id} className="bg-[#333] rounded-xl overflow-hidden hover:shadow-lg transition-shadow">
            <img 
              src={car.image} 
              alt={car.title}
            ...
            <div className="p-6">
              ...
              <div className="mb-4">
                <h3 className="font-semibold text-left text-green-700 mb-2">Includes:</h3>
              ...
              <button 
                ...
                className="w-full bg-green-700 text-white py-2 rounded-lg hover:bg-green-500 transition-colors"
              >
                Reserve Now
              </button>
            </div>
