...
const RentalCompanySignUp = () => {
  ...
  return (
    <div className="bg-[#121212] min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-[#333] rounded-lg shadow p-6 sm:p-8">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-extrabold text-[#1ecb15]">Register as a Rental Company</h2>
        ...
        <div className="mb-8">
          <div className="flex items-center">
            <div className={`flex items-center ${step >= 1 ? 'text-blue-600' : 'text-gray-500'}`}>
              ...
              <span className="ml-2 text-sm font-medium text-[#179510]">Company Details</span>
            </div>
            
            <div className="flex-1 h-0.5 mx-4 bg-gray-200">
              <div className={`h-0.5 ${step >= 2 ? 'bg-green-600' : 'bg-gray-200'}`}></div>
            </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <>
              <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                <div className="sm:col-span-2">
                  <label htmlFor="companyName" className="block text-left text-sm font-medium text-gray-300">
                    Company Name*
                  </label>
                  <input
                    id="companyName"
                    ...
                    className="mt-1 block w-full text-white px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 text-sm"
                  />
                </div>
                ...
                <div>
                  <label htmlFor="phNum" className="block text-left text-sm font-medium text-gray-300">
                    Phone Number*
                  </label>
                  <input
                    id="phNum"
                ...
                <div>
                  <label htmlFor="confirmPassword" className="block text-left text-sm font-medium text-gray-300">
                    Confirm Password*
                  </label>
                  <input
                    id="confirmPassword"
                    ...
                    onChange={handleChange}
                    className="mt-1 block text-white w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 text-sm"
                  />
                </div>
                
                <div>
                  <label htmlFor="cnic" className="block text-left text-sm font-medium text-gray-300">
                ...
                <div className="sm:col-span-2">
                  <label htmlFor="address" className="block text-left text-sm font-medium text-gray-300">
                    Address*
                  </label>
                  <input
                    id="address"
                ...
                <div>
                  <label htmlFor="city" className="block text-left text-sm font-medium text-gray-300">
                    City*
                  </label>
                  <input
                    id="city"
                ...
                <div>
                  <label htmlFor="province" className="block text-left text-sm font-medium text-gray-300">
                    Province*
                  </label>
                  <select
                    id="province"
                    ...
                    onChange={handleChange}
                    className="mt-1 block text-white bg-[#333] w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 text-sm"
                  >
          ...
          {step === 2 && (
            <>
              <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                <div>
                  <label htmlFor="bankName" className="block text-left text-sm font-medium text-gray-300">
                    Bank Name*
                  </label>
                  <input
                    id="bankName"
                ...
                <div>
                  <label htmlFor="bankTitle" className="block text-left text-sm font-medium text-gray-300">
                    Account Title*
                  </label>
                  <input
                    id="bankTitle"
                ...
                <div className="sm:col-span-2">
                  <label htmlFor="accountNo" className="block text-left text-sm font-medium text-gray-300">
                    Account Number*
                  </label>
                  <input
                    id="accountNo"
                ...
                <div>
                  <label className="block text-left text-sm font-medium text-gray-300">CNIC Front Side*</label>
                  <div className="mt-1">
                    <label htmlFor="cnicFront" className="cursor-pointer block">
                      {previews.cnicFront ? (
                        ...
                        <div className="h-40 w-full border-2 border-dashed border-gray-300 rounded-md flex flex-col items-center justify-center text-gray-400 hover:border-green-500 hover:text-green-500">
                ...
                <div>
                  <label className="block text-left text-sm font-medium text-gray-300">CNIC Back Side*</label>
                  <div className="mt-1">
                ...
                <div className="sm:col-span-2 text-xs text-gray-200">
                  <p>
