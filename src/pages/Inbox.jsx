    ...
    <div className="flex h-screen bg-black">
      ...
      <div className="w-80  bg-black">
        ...
        <div className="overflow-y-auto h-full pb-20">
          {chats.map(chat => (
            <div 
              key={chat.id}
              className={`p-4  cursor-pointer hover:bg-gray-50 ${selectedChat === chat.id ? 'bg-green-50' : ''}`}
      ...
      <div className="flex-1 flex flex-col">
        {selectedChat ? (
          <>
            {/* Chat Header */}
            <div className="p-4  bg-[#179510] flex items-center">
              <img 
              ...
              <button className="p-2 text-gray-300 hover:text-green-600">
                ...
                {messages.map(message => (
                  ...
                  >
                    <div className={`max-w-xs md:max-w-md lg:max-w-lg xl:max-w-xl p-3 rounded-lg ${
                      message.isMine ? 'bg-green-600 text-white' : 'bg-[#333] border'
                    }`}>
                      {!message.isMine && (
                        <div className="font-bold text-sm text-white">{message.sender}</div>
                      )}
                      <p className={message.isMine ? 'text-white' : 'text-gray-300'}>{message.text}</p>
