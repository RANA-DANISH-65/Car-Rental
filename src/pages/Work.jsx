...
export default function DriveFleetHomepage() {
    ...
    return (
        <div className="max-w-6xl mx-auto px-4 font-sans">
            ...
            <div className="flex text-white flex-col md:flex-row items-center justify-between py-12 gap-8">
                <div className="w-full md:w-1/2">
                    <img 
                        src="./assets/pakistan-car-rental.png" 
                        alt="Car rental in Pakistan" 
                        className="rounded-lg w-full"
                    />
                </div>
                <div className="w-full md:w-1/2 space-y-4">
                    <h1 className="text-4xl font-bold text-green-600">Drive Fleet Pakistan - Rent Cars Across the Country</h1>
                    <p className="text-lg text-gray-400">Skip the rental car counter and rent quality vehicles from local hosts in Karachi, Lahore, Islamabad, and beyond</p>
            ...
            <div className="bg-[#333] p-8 text-black rounded-lg my-12">
                <h2 className="text-3xl text-white font-bold text-center mb-8">Why Drive Fleet in Pakistan?</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[
                        ...
                        <div key={index} className="text-center p-6 bg-green-700 rounded-lg shadow-sm">
            ...
            <div className="my-12">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                        ...
                        { name: "Faislabad", image: "./assets/faislabad.jpeg" }
                    ].map((city, index) => (
            ...
            <div className="p-8 text-black">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-2xl text-green-600 font-bold">Popular Pakistani Car Brands</h2>
            ...
            <div className="my-12">
                <h2 className="text-3xl font-bold text-white text-center mb-8">
                    <span className="bg-green-700 px-4 py-1 rounded">Pakistan FAQs</span>
                </h2>
                <div className="space-y-4">
                    {[
                        ...
                        <div key={i} className=" py-4">
                            <button className="flex bg-[#333] justify-between items-center w-full text-left">
            ...
            <div className="bg-green-700 text-white p-8 rounded-lg mt-15 text-center">
                ...
                <div className="flex flex-col md:flex-row justify-center gap-4">
                    <a href="tel:+923001234567" className="bg-green-500 text-white px-6 py-2 rounded-md font-medium">
                        Call: +92 300 1234567
                    </a>
                    <a href="mailto:support@drivefleet.pk" className="bg-green-500 text-white px-6 py-2 rounded-md font-medium">
                        Email Us
                    </a>
                </div>
            </div>
