...
const CarRentalMarket = ({ brandName, carModels }) => {
  ...
  const handleCarFavorites = async (vehicleId) => {
    ...
    try {
      if (likedVehicles.includes(vehicleId)) {
        ...
        // Like (POST)
        const response = await fetch(
          `https://car-rental-backend-black.vercel.app/likes`,
          {
            method: "POST",
            headers: {
  ...
  useEffect(() => {
    const fetchLikedVehicles = async () => {
      try {
        ...
        console.log("Fetched liked vehicles:", likedIds);
      } catch (err) {
  ...
  const isVehicleAvailable = (vehicle, params) => {
    ...
    const startDay = new Date(startDate).toLocaleString("en-US", {
      weekday: "long",
    });
    const endDay = new Date(endDate).toLocaleString("en-US", {
      weekday: "long",
    });
    ...
    const isStartTimeValid =
      vehicle.availability.startTime <= startTime &&
      vehicle.availability.endTime >= startTime;
    const isEndTimeValid =
      vehicle.availability.startTime <= endTime &&
  ...
  return (
    <div className="bg-[#121212] text-white">
      {/* Header Section */}
      <div className="mb-8 text-white bg-[#121212] py-12">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <form
            ...
            className="bg-[#1ecb15] text-white rounded-lg shadow-md p-2"
          >
              ...
              <div className="flex space-x-2">
                <div className="relative">
                  <input
                    type="date"
                    name="startDate"
                    className="border-l pl-2 pr-4 py-2 text-black w-full appearance-none"
                ...
                <select
                  name="startTime"
                  className="border-l pl-2 pr-4 py-2 text-black"
      ...
      {/* Car Rental Section */}
      <h4 className="text-4xl font-bold text-white mb-6">Rental {brandName}</h4>
      <div className="flex overflow-x-auto  space-x-4 px-4 py-4">
        {filteredCars.length > 0 ? (
          filteredCars.map((car, index) => (
            <div
              key={index}
              className="w-80 border border-[#179510] rounded-lg overflow-hidden shadow-md shrink-0"
            >
              ...
              <div className="p-4">
                <div className="flex justify-between items-center mb-2">
                  <h2 className="font-bold text-white text-lg">
                    {car.manufacturer.charAt(0).toUpperCase() +
                      car.manufacturer.slice(1).toLowerCase()}{" "}
                    {car.model.charAt(0).toUpperCase() +
                      car.model.slice(1).toLowerCase()}
                  </h2>
                  <button
                    className="text-white-500 bg-green-900 hover:text-gray-700"
                ...
                <button
                  className="w-full bg-[#179510] text-white py-2 rounded mt-4"
      ...
      <div className=" text-white mt-10 py-12">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-[#1ecb15] mb-6">
            Drive a {brandName}
          </h2>
          <img
      ...
      <div className="bg-[#121212] text-white py-16">
        <div className="max-w-5xl mx-auto px-4">
          <h2 className="text-3xl text-[#179510] font-bold text-center mb-12">
            The {brandName} Experience: Adventure Awaits
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-10 mb-12">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Since its inception in 1941, {brandName} has built a reputation
                for creating vehicles that combine rugged capability with
                everyday versatility. Born from military necessity during World
                War II, {brandName} vehicles have evolved into the ultimate
                expression of freedom and adventure.
              </p>
              <p className="text-gray-300">
                Today's {brandName} lineup continues this proud tradition with
                vehicles engineered to tackle the most challenging terrains
                while providing the comfort and technology modern drivers
                expect. When you rent a {brandName}, you're not just getting
                transportation – you're getting a ticket to exploration.
              </p>
            </div>
            <div className="bg-[#333] text-gray-300 p-6 rounded-lg shadow-md">
              <h3 className="text-xl  font-bold mb-4">
                Why Choose a {brandName}?
              </h3>
          ...
          <div className="bg-[#333] p-8 rounded-lg shadow-md mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <p className="text-gray-300 mb-4">
                  When you drive a {brandName}, you join a worldwide community
                  of enthusiasts bound by a shared passion for adventure and
                  exploration. The {brandName} wave – that friendly
                  acknowledgment between {brandName} drivers on the road – is
                  just one example of this unique camaraderie.
                </p>
                <p className="text-gray-300">
                  {brandName} clubs and events can be found across the globe,
                  offering opportunities to connect with fellow adventurers,
                  learn new driving techniques, and discover challenging trails.
                  Renting a {brandName} gives you a taste of this exclusive
                  community.
                </p>
              </div>
              <div>
                <h4 className="text-lg text-green-700 font-bold mb-3">
                  Popular {brandName} Activities:
                </h4>
          ...
          <div className="text-center mt-10">
            <h3 className="text-2xl mt-10 text-white font-bold mb-6">
              Ready for Your {brandName} Adventure?
            </h3>
            <p className="text-gray-400 mb-8 max-w-2xl mx-auto">
              Whether you're planning a weekend escape, a cross-country road
              trip, or simply want to experience the thrill of driving a{" "}
              {brandName}, we have the perfect vehicle for your needs. Our
              well-maintained fleet of {brandName} vehicles gives you the
              freedom to explore with confidence.
            </p>
            <button className="bg-green-700 hover:bg-green-500 text-white font-bold py-3 px-8 rounded-lg shadow-md transition duration-300">
