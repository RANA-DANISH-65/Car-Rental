...
const Signup = () => {
  ...
  const handleChange = (e) => {
    ...
    if (name === "cnic") {
      ...
      if (numericCNIC.length > 13) {
        numericCNIC =
          numericCNIC.slice(0, 13) + "-" + numericCNIC.slice(13, 14);
      }
  ...
  const validatephoneNo = (phoneNo) => /^03\d{9}$/.test(phoneNo);
  ...
  const handleSubmit = async (e) => {
    ...
    if (!validatephoneNo(formData.phoneNo)) {
      setError("phoneNo number must be exactly 11 digits and start with '03'.");
      return;
    }
    ...
    try {
      ...
      const response = await fetch(
        "https://car-rental-backend-black.vercel.app/users/create",
        {
          method: "POST",
          body: formDataToSend,
        }
    ...
    <div className="signup-container">
      ...
      <div className="signup-right">
        <div className="signup-box">
          <h2 className="signup-heading text-[#1ecb15]">
          ...
          <form className="signup-form" onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              <label htmlFor="phoneNoNo">phoneNo Number</label>
              <input
                type="text"
                id="phoneNo"
                name="phoneNo"
