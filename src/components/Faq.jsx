...
const FAQItem = ({ question, answer }) => {
  ...
  return (
    <div className="border-b border-green-800 py-4">
      <button 
        onClick={() => setIsOpen(!isOpen)} 
        className="flex justify-between items-center text-slate-400 w-full text-left"
      >
...
const FAQSection = () => {
  ...
  return (
    <div className="max-w-4xl  mx-auto px-4 py-12">
      <h1 className="text-4xl text-green-700 font-bold text-center mb-12">Frequently asked questions</h1>
      <div>
        {faqs.map((faq, index) => (
          <FAQItem 
            key={index} 
